...
export default function App() {
  ...
  const [webhookUrl, setWebhookUrl] = useState("https://wh.jandi.com/connect-api/webhook/27388464/e1452e890e3d5a5ad99b5429cfde65cd");
  ...
  const handleGoogleSheetsDataLoaded = (data: {
    ...
    const mappedSurveys = Object.values(groupedSurveys).map((g) => {
      ...
      const matchingMain = mappedMains.find(
        (m) => m.rookie === g.respondent || m.buddy === g.respondent || m.department === g.department
      );
                      ...
                      <table className="w-full text-left text-xs whitespace-nowrap">
                        ...
                        <tbody className="divide-y divide-slate-100 font-medium text-slate-650">
                          <tr className="hover:bg-slate-50/70 border-b border-slate-100">
                            <td className="px-4 py-3 font-bold text-slate-900">13기</td>
                            <td className="px-4 py-3 text-center font-bold text-slate-500">2명</td>
                            <td className="px-4 py-3 text-center text-emerald-600 font-bold">100%</td>
                            <td className="px-4 py-3 text-center text-indigo-600 font-bold">0%</td>
                            <td className="px-4 py-3 text-right font-bold text-slate-800">4.30점</td>
                          </tr>
                          <tr className="hover:bg-slate-50/70 border-b border-slate-100">
                            <td className="px-4 py-3 font-bold text-slate-900">12기</td>
                            <td className="px-4 py-3 text-center font-bold text-slate-500">2명</td>
                            <td className="px-4 py-3 text-center text-emerald-600 font-bold">100%</td>
                            <td className="px-4 py-3 text-center text-indigo-600 font-bold">100%</td>
                            <td className="px-4 py-3 text-right font-bold text-slate-800">4.35점</td>
                          </tr>
                          <tr className="hover:bg-slate-50/70 border-b border-slate-100">
                            <td className="px-4 py-3 font-bold text-slate-900">11기</td>
                            <td className="px-4 py-3 text-center font-bold text-slate-500">2명</td>
                            <td className="px-4 py-3 text-center text-emerald-600 font-bold">100%</td>
                            <td className="px-4 py-3 text-center text-indigo-600 font-bold">100%</td>
                            <td className="px-4 py-3 text-right font-bold text-slate-800">4.40점</td>
                          </tr>
                          <tr className="hover:bg-slate-50/70 border-b border-slate-100">
                            <td className="px-4 py-3 font-bold text-slate-900">10기</td>
                            <td className="px-4 py-3 text-center font-bold text-slate-500">1명</td>
                            <td className="px-4 py-3 text-center text-emerald-600 font-bold">100%</td>
                            <td className="px-4 py-3 text-center text-indigo-600 font-bold">100%</td>
                            <td className="px-4 py-3 text-right font-bold text-slate-800">4.00점</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
